<?php
  ...
  require_once("admin_status.php");
 	if (logged_in() == true) {
    include('admin_new_customer_server.php');
 		?>
<!doctype html>
<html lang="en">
<head>
  	    ...
  	    <div class="main-panel">
            ...
            <div class="content">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="content">
                                      ...
                                      <input id="mobileError" type="hidden" value="<?php echo $mobileError ?>">
    																</div>
    															</div>
    															<div class="row">
    																<div class="col-md-7" style="color:red;">
                                    ...
                                    <form method="post" action="admin_new_customer.php">
              ...
              <script>
                ...
                var fname1 = 1, lname1 = 1, email1 = 1, email2 = 1, mobile1 = 1, pass1 = 1, pass2 = 1;
              ...
              fname.onkeyup = function() {
                ...
                if((fname1 == 0) && (lname1 == 0) && (email1 == 0) && (email2 == 0) && (mobile1 == 0) && (pass1 == 0) && (pass2 == 0)){
