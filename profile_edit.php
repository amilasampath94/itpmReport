<?php
include('profile_edit_server.php');
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                  ...
                                  <?php
                                    if($displ != ""){
                                      ...
                                      <h4 class="title"><?php echo $fname = $_SESSION['fname'];?> <?php echo $lname = $_SESSION['lname'];?><br />
																				<br>
                                      </h4>
                                ...
                                <form action="profile_edit.php" enctype="multipart/form-data" method="post">
																	...
																	<div class="row">
																		<div class="col-md-6">
																				<div class="form-group">
																						...
																						<input name="current_pass" type="password" class="form-control" placeholder="Current Password">
																				</div>
																		</div>
																		</div>
																		<div class="row">
