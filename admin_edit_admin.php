<?php
  ...
  require_once("admin_status.php");
    ...
    include('admin_edit_admin_server.php');
 		?>
<!doctype html>
<html lang="en">
<head>
                                ...
                                <div class="card">
                                    ...
                                    <div class="content">
                                      ...
                                      <div class="row">
                                        ...
                                        <form method="post" action="admin_edit_admin.php">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-6">
                                                <div class="form-group">
                                                  ...
                                                  <input name="type" type="text" class="form-control" placeholder="Admin Type" value="<?php echo $type_1;?>">
                                                </div>
                                              </div>
                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card card-user">
                                    ...
                                    <div class="content">
                                        ...
                                        <form action="admin_edit_admin.php" enctype="multipart/form-data" method="post">
