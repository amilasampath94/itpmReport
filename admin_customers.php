<?php
  ...
  require_once("admin_status.php");
 	if (logged_in() == true) {
    include('admin_customers_server.php');
 		?>
<!doctype html>
<html lang="en">
<head>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                      ...
                                      <br>
                                      <p class="category">All Customers : <?php echo $numCustomers; ?></p>
                                    </div>
                                            ...
                                            <tbody>
                                              ...
                                              while ($row = mysqli_fetch_array($customer))
                                              {
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    <?php
                                                      if($row['image'] != ""){
                                                        ...
                                                        echo '<img class="avatar border-gray" src="'.$row['picture'].'" alt="..."/>';
                                                      } ?>
                                                  </td>
                                                  ...
                                                  <td>
                                                    <?php echo '<a href="admin_profile_customer.php?email='.$row['email'].'">
                                                      <img src="images/view.png" style="height:20px; width:20px; margin-right:3px;">
                                                    </a>
                                                    <a href="admin_edit_customer.php?email='.$row['email'].'">
                                                      <img src="images/edit.png" style="height:20px; width:20px; margin-right:3px;">
                                                    </a>
                                                    <a href="admin_delete_customer.php?email='.$row['email'].'">
