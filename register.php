...
<form id="regForm" method="post" action="register.php">
  ...
  <div class="tab">
    <div class="input-group">
      ...
      <input placeholder="minimum 8 characters" type="password" name="password_1" id="password"
       autocomplete="none"  oninput="this.className = ''" max="20" >
         ...
         <a class="st">strength : </a><progress class="strength" max="100" value="0" id="strength"></progress>
    </div>
    <div class="input-group">
    ...
    <label style="color:white; float: left; font-size:small; padding-left: 26px;">
      <input name="show1" onclick="showpass()" type="checkbox">Show Password
    </label>
  </div>
...
<div class="right-section">
  ...
  <div id="fb" style="color:white; background:rgba(0, 0, 0, 0.7);"><br>------------------- OR ------------------<br><br>
    <?php echo $output; ?>
  <br><br>
  </div>
  ...
  var f = 0, l = 0, e1 = 0, e2 = 0, m = 0, p = 0, c = 0;
