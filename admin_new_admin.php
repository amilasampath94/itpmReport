<?php
  ...
  require_once("admin_status.php");
 	if (logged_in() == true) {
    include('admin_new_admin_server.php');
 		?>
<!doctype html>
<html lang="en">
<head>
...
<body>
	...
	<div class="wrapper">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="content">
                                                      ...
                                                      <input id="usernameError" type="hidden" value="<?php echo $usernameError ?>">
                    																</div>
                    															</div>
                    															<div class="row">
                    																<div class="col-md-7" style="color:red;">
                                                    ...
                                                    <form method="post" action="admin_new_admin.php">
                                                      ...
                                                      <div class="row">
                    																			<div class="col-md-6">
                    																					<div class="form-group">
                    																							...
                    																							<input id="username" name="username" type="text" class="form-control" autocomplete="off" placeholder="Username" value="<?php echo $username?>">
                                                                  <div id="uname" class="msg">
                                                                    <p id="uname1" style="color : #f44336;">Only letters & numbers are allowed in <b>username</b></p>
                                                                    <p id="uname2" style="color : #f44336;">Minimum 5 characters</p>
                                                                  </div>
                                                              </div>
                    																			</div>
                    																			<div class="col-md-6">
                      																...
                      																<div class="row">
                  																			<div class="col-md-6">
                  																					<div class="form-group">
                  																							...
                  																							<input id="email" name="email" type="email" class="form-control" autocomplete="off" placeholder="Email" value="<?php echo $email;?>">
                                                      ...
                                                      <div class="row">
                                                        <div class="col-md-6">
                                                          <div class="form-group">
                                                            ...
                                                            <input id="password" name="password_1" type="password" class="form-control" placeholder="Password">
                                                      ...
                                                      <br>
                                                      <button id="button" disabled name="reg_user" type="submit" class="btn btn-info btn-fill pull-right">Submit</button>
                                                    </form>
                                                    <br><br><br>
                                                  </div>
                                                </div>
      ...
      var fname1 = 1, lname1 = 1, email1 = 1, email2 = 1, mobile1 = 1, pass1 = 1, pass2 = 1, uname1 = 1, uname2 = 1;
    ...
    fname.onkeyup = function() {
      ...
      if((fname1 == 0) && (lname1 == 0) && (email1 == 0) && (email2 == 0) && (mobile1 == 0) && (pass1 == 0) && (pass2 == 0) && (uname1 == 0) && (uname1 == 0)){
    ...
    lname.onkeyup = function() {
      ...
      if(document.getElementById("mobileError").value != ""){
        fname1=0;
        lname1=0;
        email1=0;
        email2=0;
