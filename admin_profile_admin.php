<?php
  ...
  require_once("admin_status.php");
    ...
    if(!((isset($_POST['update_profile']))||(isset($_POST['change_pass']))||(isset($_POST["image"])))) {
        $_SESSION['adminUsername'] = $_GET['un'];
    }
    include('admin_profile_admin_server.php');
 		?>
<!doctype html>
<html lang="en">
<head>
                       ...
                       <div class="col-md-12">
                         <div class="card card-user">
                            ...
                            <div class="content">
                              ...
                              <?php
                              echo '<a href="pdf_admin_admins.php?un='.$username.'">
                                <button type="submit" class="btn btn-info btn-fill pull-left">Download Details</button>
                              </a>
                              <a href="admin_delete_admin.php?un='.$username.'">
                                <button type="submit" class="btn btn-info btn-fill pull-right">Delete Account</button>
                              </a>
                              <a href="admin_edit_admin.php?un='.$username.'">
